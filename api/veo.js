...
function buildPrompt(voiceStyle, compliment, elevenLabs) {
  const audioSection = elevenLabs
    ? (
      ...
      `AUDIO — CRITICAL: The ONLY sound anywhere in this entire video is a single short mechanical "CLICK" at the exact instant the paw presses the yellow button down. ` +
      `There is NO voice, NO speech, NO talking, NO words, NO singing, NO music, NO narration anywhere — total silence apart from that one click. Do NOT generate any spoken audio at all. ` +
      `\n\n` +
